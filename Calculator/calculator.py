...
#import sys
#sys.path.append(r'D:\Sem 8\SQA\Assignments\Assignment1')  # Add the directory, not the specific Python file

from CC import showgraph
from Hal import showHalsteadGraph

showgraph("calculator.py")
showHalsteadGraph("calculator.py")
